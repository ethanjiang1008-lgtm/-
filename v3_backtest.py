...
用法：python v3_backtest.py <cache.csv>
"""
import sys
import pandas as pd
...
def run_pool(m, pool_name, pool_mask=None, tops=(1, 2, 3, 5)):
    """每天从池中选综合分 TOPn，统计次日连板命中率。"""
...
def main():
    ...
    for lo, hi, label in [(0, 3, "<3"), (3, 5, "3-5"), (5, 10, "5-10"), (10, 100, "≥10")]:
        ...
        r = run_pool(m, "fb-turn", mask, tops=(1,))
        o, tr, va = r[1]
