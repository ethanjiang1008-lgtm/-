...
<div class="wrap">
  ...
  <div class="panel">
    ...
    <table>
      ...
      <tr><td>全池 TOP1</td><td>49.53% (n=319)</td><td class="up">57.05%</td><td class="up">+7.5pp</td><td>57.78% / 56.12%</td></tr>
      <tr><td>全池 TOP3</td><td>47.54% (n=957)</td><td class="up">54.02%</td><td class="up">+6.5pp</td><td>57.04% / 50.12%</td></tr>
      <tr><td>全池 TOP5</td><td>40.31% (n=1595)</td><td class="up">49.97%</td><td class="up">+9.7pp</td><td>53.78% / 45.04%</td></tr>
      <tr><td>低位池(1-3板) TOP1</td><td>47.65% (n=319)</td><td class="up">56.74%</td><td class="up">+9.1pp</td><td>61.11% / 51.08%</td></tr>
      <tr><td>首板池 TOP1</td><td>25.08% (n=319)</td><td class="up">35.42%</td><td class="up">+10.3pp</td><td>41.11% / 28.06%</td></tr>
      <tr><td>首板池 TOP5</td><td>23.40% (n=1595)</td><td class="up">26.60%</td><td class="up">+3.2pp</td><td>28.22% / 24.50%</td></tr>
    </table>
    <div class="note">v3 权重由网格搜索得出（身位30% 频率20% 动量15% 换手15% 放量10% 情绪10%），按「训练/验证两段均衡」选取，非全期最优。</div>
  </div>
  ...
  <div class="panel">
    ...
    <ul>
      <li><b>信息极限</b>：首板次日晋级二板的全市场基准仅 16.27%（一年实测）。v2 首板 TOP1 25.08% → v3 35.42%，已是纯历史量价数据的显著提升。</li>
